...
enum class BubbleAnim { INSHOOT, IDLE, POP, GREENZENCHAN, YELLOWZENCHAN, REDZENCHAN, GREENINVADER, YELLOWINVADER, REDINVADER, GREENMIGHTA, YELLOWMIGHTA, REDMIGHTA, GREENDRUNK, YELLOWDRUNK, REDDRUNK, NUM_ANIMATIONS };
